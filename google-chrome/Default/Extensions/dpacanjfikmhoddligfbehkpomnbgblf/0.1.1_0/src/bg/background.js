(function(){
    ...
    var g_recognizer_client = (function() {
        ...
        this._server_url = "https://api.acrcloud.com/v1/aha-music/identify";
        this._params = {};
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data['status'] == 0) {
                        ...
                        chrome.runtime.sendMessage({cmd: "popup_parse_result", result: {"status": 0, "msg": "", "data": song}});
                        self._storage_helper.set(song);
                        self.reload();
                    } else if (data['status'] == -2) {
                        _do_recognize_auth(audio_buffer);
                    } else if (data['status'] == -3) {
                        chrome.runtime.sendMessage({cmd: "popup_update_version", result: {"status": -1, "msg": data['msg']}});
                    } else {
    ...
    chrome.runtime.onMessage.addListener( function(request, sender, sendResponse) {
        ...
        switch (request.cmd) {
            case "background_start":
                chrome.tabs.query({active:true, currentWindow:true}, function(tabs) {
                    ...
                    if (!current_tag['audible']) {
                        chrome.runtime.sendMessage({cmd: "popup_error", result: {"status": -1, "msg": "No Sound Playing in Current Tab"}});
                        return;
                    }
            ...
            case "background_clear_history":
                ...
                chrome.notifications.create("clear_history", {buttons:[{title:"Yes"},{title:"No"}],
                    title:"Confirm", message:"Do you want to clear history?", type:"basic", requireInteraction: true,
