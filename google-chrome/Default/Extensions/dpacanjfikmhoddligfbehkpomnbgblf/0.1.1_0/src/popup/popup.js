(function(){
    var _gaq = _gaq || [];
    _gaq.push(['_setAccount', 'UA-101242276-1']);
            ...
            function(request, sender, sendResponse) {
                switch (request.cmd) {
                    ...
                    case "popup_parse_result":
                        _popup_view.show_new_result(request.result["data"]);
                        break;
                    case "popup_error":
                        console.log(request.result);
                    ...
                    case "popup_update_version":
                        ...
                        break;
                    case "popup_login":
                        _popup_view.show_message('Please <a url="chrome://chrome-signin/" href="#"> login with your google account</a>', -1);
                        break;
                }
    ...
    function init() {
        ...
        $("#search_bar_start").click(function() {
            _gaq.push(['_trackEvent', "search_bar_start", 'clicked']);
            recognizer_controller.start();
        });
    
        $("#recycle").click(function() {
            _gaq.push(['_trackEvent', "recycle", 'clicked']);
